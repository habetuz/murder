...
using Murder.Adapters.CredentialRepository.InMemory;
using Murder.Adapters.GameRepositoy.InMemory;
using Murder.Adapters.IdentityRepository.InMemory;
using Murder.Adapters.WebAPI;
using Murder.Adapters.WebAPI.Authentication;
using Murder.Adapters.WebAPI.Watch;
